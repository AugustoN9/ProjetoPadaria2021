...
@WebServlet("/boloControlador")
public class boloControlador extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public boloControlador() {
        super();
    }
...
//			if(acesso.equals("administrador")) {
				...
				int registros=0;
				try {
					registros = paoDao.quantosboloRegistrados();
				} catch (SQLException e) {
					e.printStackTrace();
				}
				request.setAttribute("registros", registros);
				RequestDispatcher saida = request.getRequestDispatcher("listarprodutoBolo.jsp");
