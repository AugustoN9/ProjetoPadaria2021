...
@WebServlet("/paoControlador")
public class paoControlador extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public paoControlador() {
        super();
    }
...
//			if(acesso.equals("administrador")) {
				...
				int registros=0;
				try {
					registros = paoDao.quantospaoRegistrados();
				} catch (SQLException e) {
					e.printStackTrace();
				}
				request.setAttribute("registros", registros);
				RequestDispatcher saida = request.getRequestDispatcher("listarprodutoPao.jsp");
