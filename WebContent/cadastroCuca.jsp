...
<div id="conteudo">
	...
	<div class="form-group text-center">		
		<h3 class="fontp"><strong>Cadastro de Cucas</strong></h3>
	</div>
		...
		<label>Categoria</label><br>
			<select class="form-control" name="categoria" id="categoria" >
				<option value="cuca">Cucas</option>
			</select>	
		</div>
		</div>
		<div class="col-sm-3">
	...
	<div id="lista">
		...
		<tbody>			
			<tr bgcolor="7e7e7e" >
				...
				<th style="text-align: center;"><a href="cucaAdmControlador?acao=alt&id=<%=p.getCodProduto() %>"><img src="img/icones/editar.png" height="18" width="20"></a></th>
	...
	<script>
		function confirmaExcluir(id){
			if(window.confirm("Tem certeza que deseja excluir este produto ?")){
				location.href="cucaAdmControlador?acao=ex&id="+ id;
			}			
		}	
	</script>
