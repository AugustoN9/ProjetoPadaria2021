	...
	<div id="conteudo">
		...
		<div class="container col-lg-12 font4"> 
		  <div class="row">
		    ...
		    <div class="col-sm font_info"><h3><%=registros +" "%>Bolos Registrados</h3></div>	
		  </div>
		</div>
	...
	<div id="lista">
		...
		<tbody>			
			<tr bgcolor="7e7e7e" >
				...
				<th style="text-align: center;" ><a href="boloAdmControlador?acao=det&id=<%=p.getCodProduto() %>" ><img src="img/icones/cestacompras.png" height="36" width="36"></a></th>
