...
<div id="conteudo">
	...
	<form id="cadastroBolo" action="salvacadastroPao.jsp" method="post" >
	
	<div class="form-group text-center">		
		<h3 class="fontp"><strong>Cadastro de Bolos</strong></h3>
	</div>
		...
		<input class="form-control" type="date" name="validade" placeholder="Informe a validade">	
		</div>
		</div>
		<div class="col-sm-3">
		<div class="form-group">			
...
<div id="conteudo">
	...
	<div id="lista">
		...
		<tbody>			
			<tr bgcolor="7e7e7e" >
				<th><img src="img/produtos/bolo/<%=p.getImagem() %>" width="120" height="80"></th>
				...
				<th style="text-align: center;"><a href="boloAdmControlador?acao=alt&id=<%=p.getCodProduto() %>"><img src="img/icones/editar.png" height="18" width="20"></a></th>
	...
	<script>
		function confirmaExcluir(id){
			if(window.confirm("Tem certeza que deseja excluir este produto ?")){
				location.href="boloAdmControlador?acao=ex&id="+ id;
			}			
		}	
	</script>
